    ...
    <div class="container">
        <div class="text-center">
            ...
            <div class="d-flex justify-content-center gap-2 flex-wrap">
                <a href="tel:+971000000000" class="btn btn-sm px-3" 
                   style="background: linear-gradient(135deg, var(--primary), var(--primary-dark)); border: none; color: white;">
                    <i class="bi bi-telephone me-1"></i> Call Now
                </a>
                <a href="https://wa.me/971000000000" class="btn btn-sm px-3" 
                   style="background: linear-gradient(135deg, var(--tesla-green), #1da851); border: none; color: white;">
                    <i class="bi bi-whatsapp me-1"></i> WhatsApp
                </a>
                <a href="mailto:info@onecall.ae" class="btn btn-sm px-3" 
                   style="background: transparent; border: 1px solid var(--primary-light); color: var(--primary-light);">
            ...
            <div class="footer-grid" style="display: grid; grid-template-columns: 2fr 1.5fr 1.5fr 1fr; gap: 40px;">
                ...
                <div class="footer-col">
                    ...
                    <div class="social-links mt-3" style="display: flex; gap: 15px;">
                        ...
                        <a href="https://wa.me/971582309268" class="social-link" aria-label="WhatsApp" target="_blank"
                           style="width: 40px; height: 40px; border-radius: 50%; background: rgba(255, 255, 255, 0.1); display: flex; align-items: center; justify-content: center; color: white; text-decoration: none; transition: all 0.3s ease;">
                ...
                <div class="footer-col">
                    ...
                    <ul class="services-list" style="list-style: none; padding: 0; margin: 0; display: flex; flex-direction: column; gap: 12px;">
                        <li><a href="#" style="color: rgba(255, 255, 255, 0.8); text-decoration: none; font-size: 0.95rem; transition: all 0.3s ease;">AC and Ventilation in Dubai</a></li>
                        <li><a href="#" style="color: rgba(255, 255, 255, 0.8); text-decoration: none; font-size: 0.95rem; transition: all 0.3s ease;">Aluminum & Glass Works in Dubai</a></li>
                        <li><a href="#" style="color: rgba(255, 255, 255, 0.8); text-decoration: none; font-size: 0.95rem; transition: all 0.3s ease;">CCTV Cameras in Dubai</a></li>
                        <li><a href="#" style="color: rgba(255, 255, 255, 0.8); text-decoration: none; font-size: 0.95rem; transition: all 0.3s ease;">Electric Work in Dubai</a></li>
                        <li><a href="#" style="color: rgba(255, 255, 255, 0.8); text-decoration: none; font-size: 0.95rem; transition: all 0.3s ease;">Gypsum Partition & Ceiling Work in Dubai</a></li>
                        <li><a href="#" style="color: rgba(255, 255, 255, 0.8); text-decoration: none; font-size: 0.95rem; transition: all 0.3s ease;">Painting Work in Dubai</a></li>
                        <li><a href="#" style="color: rgba(255, 255, 255, 0.8); text-decoration: none; font-size: 0.95rem; transition: all 0.3s ease;">Plumber Work in Dubai</a></li>
                        <li><a href="#" style="color: rgba(255, 255, 255, 0.8); text-decoration: none; font-size: 0.95rem; transition: all 0.3s ease;">Tesla charger installation in Dubai</a></li>
                        <li><a href="#" style="color: rgba(255, 255, 255, 0.8); text-decoration: none; font-size: 0.95rem; transition: all 0.3s ease;">Tiling Work in Dubai</a></li>
                    </ul>
                </div>
                ...
                <div class="footer-col">
                    ...
                    <ul class="links-list" style="list-style: none; padding: 0; margin: 0; display: flex; flex-direction: column; gap: 12px;">
                        ...
                        <li><a href="/quote" style="color: rgba(255, 255, 255, 0.8); text-decoration: none; font-size: 0.95rem; transition: all 0.3s ease;">Get Quote</a></li>
